...
# User agents rotativos amplios y actualizados (Chrome, Firefox, Safari, Edge, en Windows, Mac, Linux, iOS, Android)
USER_AGENTS = [
    # Chrome on Windows (v110 to v130)
...
INDICATORS = {
    'adyen': ['adyen.com', 'checkoutshopper', 'adyen-dropin', 'adyen'],
    'stripe': ['stripe.com', 'js.stripe.com', 'stripe-elements', 'cardnumber', 'stripe'],
